...
fn dt_test_find_split() {
    ...
    let val_y_0 = i64 { mag: 0_u64, sign: false };
    let val_y_1 = i64 { mag: 0_u64, sign: false };
    let val_y_2 = i64 { mag: 1_u64, sign: false };
    let val_y_3 = i64 { mag: 0_u64, sign: false };
    let val_y_4 = i64 { mag: 0_u64, sign: false };
    let val_y_5 = i64 { mag: 0_u64, sign: false };
    let val_y_6 = i64 { mag: 1_u64, sign: false };
    let val_y_7 = i64 { mag: 0_u64, sign: false };
    let val_y_8 = i64 { mag: 1_u64, sign: false };
    let val_y_9 = i64 { mag: 2_u64, sign: false };
